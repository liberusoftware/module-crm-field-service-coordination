...
> This package is the authoritative, provider-neutral implementation of Field Service Coordination. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-crm-field-service-coordination?sort=semver)](https://github.com/liberusoftware/module-crm-field-service-coordination/releases/latest) [![Tests](https://github.com/liberusoftware/module-crm-field-service-coordination/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-crm-field-service-coordination/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-crm-field-service-coordination
```
...
<a href="https://github.com/liberusoftware/module-crm-field-service-coordination/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-crm-field-service-coordination" alt="Contributors to liberusoftware/module-crm-field-service-coordination">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-crm-field-service-coordination/graphs/contributors).
